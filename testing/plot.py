...
random_data = np.genfromtxt(Path("./test_data/full_random_data.csv"), delimiter = ',')
random_time = random_data[-1]
random_data = random_data[:-1] 

entropy_data = np.genfromtxt(Path("./test_data/full_entropy_data.csv"), delimiter = ',')
